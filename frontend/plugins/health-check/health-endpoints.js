// health-endpoints.js
// Sağlık kontrolleri ve izleme için API uç noktaları
...
/**
 * Geliştirme sunucusunda sağlık kontrolü uç noktalarını yapılandır
 * @param {Object} devServer - Webpack geliştirme sunucusu örneği
 * @param {Object} healthPlugin - WebpackHealthPlugin örneği
 */
function setupHealthEndpoints(devServer, healthPlugin) {
  ...
  // ====================================================================
  // GET /health – Ayrıntılı sağlık durumu (JSON)
  // ====================================================================
  ...
  // ====================================================================
  //GET /health/simple – Basit metin yanıtı (OK/COMPILING/ERROR)
  // ====================================================================
  ...
  // ====================================================================
  // GET /health/ready – Hazır olma kontrolü (Kubernetes/yük dengeleyici)
  // ====================================================================
  ...
  // ====================================================================
  // GET /health/live – Canlılık kontrolü (Kubernetes)
  // ====================================================================
  ...
  // ====================================================================
  // GET /health/errors – Mevcut hata ve uyarıları al
  // ====================================================================
  ...
  // ====================================================================
  // GET /health/stats – Derleme istatistikleri
  // ====================================================================
...
/**
 * Baytları insan tarafından okunabilir biçime dönüştür
 * @param {number} bytes
 * @returns {string}
 */
...
/**
 * Süreyi insan tarafından okunabilir biçime dönüştür
 * @param {number} ms -Süre (milisaniye cinsinden)
 * @returns {string}
 */
