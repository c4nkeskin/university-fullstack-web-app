...
// Derleme durumu ve sağlık metriklerini izleyen Webpack eklentisi
...
class WebpackHealthPlugin {
  ...
  apply(compiler) {
    ...
    // Geçersiz (dosya değişti, yeniden derleniyor)
  ...
  // Hızlı kontroller için basitleştirilmiş durumu al
  getSimpleStatus() {
    return {
  ...
  // İstatistikleri sıfırla (test için faydalı)
  reset() {
    this.status = {
      state: 'idle',
      errors: [],
